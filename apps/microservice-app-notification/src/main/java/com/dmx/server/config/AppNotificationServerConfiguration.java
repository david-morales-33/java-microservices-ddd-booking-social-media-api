...
@Configuration
public class AppNotificationServerConfiguration {

	private final RequestMappingHandlerMapping mapping;

	public AppNotificationServerConfiguration(@Qualifier("requestMappingHandlerMapping") RequestMappingHandlerMapping mapping) {
