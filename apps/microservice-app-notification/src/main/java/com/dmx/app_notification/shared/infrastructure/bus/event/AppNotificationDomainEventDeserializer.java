...
public class AppNotificationDomainEventDeserializer {
    private final AppNotificationDomainEventInformation events = new AppNotificationDomainEventInformation();
    ...
    public DomainEvent deserialize(String message) throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException, JsonProcessingException {
        ...
        Class<? extends DomainEvent> domainEventClass = events.forName((String) body.get("evt_name").asText());
