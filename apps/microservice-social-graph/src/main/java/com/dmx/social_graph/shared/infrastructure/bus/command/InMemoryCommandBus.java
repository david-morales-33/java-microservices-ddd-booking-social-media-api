...
public final class InMemoryCommandBus implements CommandBus {
    private final SocialGraphCommandHandlersInformation information;
    private final ApplicationContext         context;

    public InMemoryCommandBus(SocialGraphCommandHandlersInformation information, ApplicationContext context) {
