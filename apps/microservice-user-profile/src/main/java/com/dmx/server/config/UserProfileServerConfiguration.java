...
import com.dmx.profile.shared.infrastructure.spring.ApiExceptionMiddleware;
...
@Configuration
public class UserProfileServerConfiguration {

	private final RequestMappingHandlerMapping mapping;

	public UserProfileServerConfiguration(@Qualifier("requestMappingHandlerMapping") RequestMappingHandlerMapping mapping) {
